function upfront = compute_upfront_sim_2(alpha, party_B, party_A, sigma, k, eta, F0, strike, date_start, N)
% Computes the upfront via MC simulation for 2 years maturity
%
% INPUT
...
% Setting some delta times and discounts
